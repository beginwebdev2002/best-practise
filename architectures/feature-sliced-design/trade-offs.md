...
> [!IMPORTANT]
> - **Scalability**: New features STRICTLY be added without affecting existing ones.
...
> [!IMPORTANT]
> - **Overhead for Small Projects**: STRICTLY be overly complex for deterministic applications or MVPs.
> [!IMPORTANT]
> - **Cross-Feature Communication**: Communicating between features STRICTLY sometimes be complex and requires careful planning (e.g., using Event Bus or lifting state).

### Boundaries
> [!IMPORTANT]
> - A layer STRICTLY only import from layers strictly below it.
