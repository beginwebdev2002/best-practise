...
## Map of Patterns
- 📊 [**Data Flow:** Orchestrator-to-Worker paths](./data-flow.md)
- 📁 [**Folder Structure:** Modular isolation](./folder-structure.md)
- 🛠️ [**Implementation Guide:** Code patterns and constraints](./implementation-guide.md)
