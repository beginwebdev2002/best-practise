...
Rules for defining strict agent personas and constraints.
...
### ⚠️ Problem
Loading a monolithic agent with unbounded context leads to Context Explosion.
...
### 🚀 Solution
Implementing an Orchestrator-Worker pattern strictly isolates responsibilities.
