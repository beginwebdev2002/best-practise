...
> [!IMPORTANT]
> **Separation of Concerns:** Frontend teams MUST manage their own backend logic without affecting other clients or waiting on core backend teams.
> [!IMPORTANT]
> **Resilience:** The BFF MUST provide fallback data or graceful error handling if a downstream service fails.
...
> [!IMPORTANT]
> **Code Duplication:** Multiple BFFs (e.g., one for Web, one for Mobile) MANDATORY end up duplicating aggregation logic.
