...
> [!IMPORTANT]
> [!IMPORTANT]
> **Isolation:** Components in a specific layer STRICTLY only import components from layers located below them. Never violate the flow of unidirectional dependencies (one-way data flow) in FSD.
