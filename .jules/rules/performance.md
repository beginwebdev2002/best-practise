...
## 1. 🎯 Context & Scope
- **Primary Goal:** Ensure all generated code meets strict **performance optimization** standards, guaranteeing O(1)/O(n) load times, efficient resource usage, and global **scalability**.
